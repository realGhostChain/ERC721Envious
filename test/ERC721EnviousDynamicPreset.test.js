...
contract("ERC721EnviousDynamicPreset", function(accounts) {
    ...
    beforeEach(async function() {
        ...
        this.token = await ERC721EnviousMock.new(name, symbol, uri, edgeValues, edgeOffsets, edgeRanges, this.measureToken.address);
    ...
    shouldSupportInterfaces([ "ERC721Envious", "ERC721EnviousDynamic" ]);
});