...
const ERC20Mock = artifacts.require("BaseToken");

contract("Base ERC20 Token", function(accounts) {
    const [ initialHolder, recipient, anotherAccount ] = accounts;
    const name = "My Token";
    const symbol = "MTKN";
    const initialSupply = new BN(100);
    beforeEach(async function() {
        this.token = await ERC20Mock.new(name, symbol);
    ...
    shouldBehaveLikeERC20Burnable("ERC20", initialHolder, initialSupply, anotherAccount);
    ...
    describe("_burn", function() {
        describe("for a non zero account", function() {
            it("rejects burning more than balance", async function() {
                await expectRevert(this.token.burn(initialSupply.addn(1), {
                    from: initialHolder
