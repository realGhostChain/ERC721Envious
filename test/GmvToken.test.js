...
const { shouldBehaveLikeERC20Burnable } = require('./ERC20/ERC20Burnable.behavior');
...
contract('GhostMcAfeeVision Token (GMV)', function (accounts) {
  ...
  it('only super user can renew super minter', async function () {
    await expectRevert(this.token.renewSuperMinter(anotherAccount, { from: anotherAccount }), 'not a super user');
  });
